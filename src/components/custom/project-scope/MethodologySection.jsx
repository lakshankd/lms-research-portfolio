            ...
            <div className="col-lg-6 pe-lg-5">
              ...
              >
                ...
                <ol className="text-secondary wow bounceInUp custom_ol my-16 ps-48">
                  <li className="mb-8">
                    Dynamic knowledge assessment and personalized path
                    generation
                  </li>
                  <li className="mb-8">
                ...
                <p className="text-secondary custom-text-justify wow bounceInUp">
                  ...
                  preferences. The system employed Self-Organizing Maps (SOMs)
                  to cluster students based on learning patterns and XGBoost
                  Regressor to predict Grade Point Average (GPA). Personalized
                  content was recommended using Artificial Neural Networks
                  (ANNs) and content-based filtering, tailored to learning
                  styles and engagement levels. Ridge Regression was used for
                  performance prediction, and XGBoost classifiers, combined with
                  GNNs and Social Network Analysis (SNA), enabled effective peer
                  group formation. Data preprocessing included imputation,
                  ...
                  dynamic, responsive platforms that support individual growth
